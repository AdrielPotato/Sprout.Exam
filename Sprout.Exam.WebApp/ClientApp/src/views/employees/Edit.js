...
<button type="button" onClick={() => this.props.history.push("/employees/index")} className="btn btn-primary">Back</button>
  ...
  async getEmployee(id) {
    ...
    this.setState({ id: data.payload.id,fullName: data.payload.fullName,birthdate: data.payload.birthdate,tin: data.payload.tin,typeId: data.payload.typeId, loading: false,loadingSave: false });
  }
