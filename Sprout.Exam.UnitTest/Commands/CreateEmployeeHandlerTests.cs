...
namespace Sprout.Exam.UnitTest.Commands
{
    public class CreateEmployeeHandlerTests
    {
        ...
        private readonly Mock<ILogger<CreateEmployeeHandler>> _loggerMock;
        ...
        public CreateEmployeeHandlerTests()
        {
            ...
            _loggerMock = new Mock<ILogger<CreateEmployeeHandler>>();

            var mapperProfile = new MappingProfile();

            mapperProfile.CreateMap<CreateEmployeeCommand, Employee>()
            ...
            _handler = new CreateEmployeeHandler(_employeeRepository, _mapper, _loggerMock.Object);
        }
        ...
        {
            //Arrange
            var fakeQuery = new CreateEmployeeCommand()
            {
